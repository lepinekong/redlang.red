...
context [
		...
		switch type?/word value [
			file! [
				...
				all [
					...
					repend out [newline either dir? value [			; ]
				...
				all [
					...
					if contents: attempt [read directory/:value][		; and it is not a fake directory
						...
						make-dir-tree/pref/dir/only-dirs/expand/dep/red/lin contents copy changeprefix directory/:value dirs levels depth + 1 frm lins
					]
				]
			]
			block! [
				...
				foreach item value [
					...
					make-dir-tree/pref/chpref/dir/only-dirs/expand/dep/red/lin item copy addprefix copy changeprefix directory dirs levels depth frm lins
				]
			]
		]
	]
	set 'dir-tree func [
		...
		clear out 
		refs: copy [make-dir-tree]
		foreach ref [only redish lines][if get ref [append refs ref]]
		either expand [do reduce [to-path append refs 'expand value levels]][do reduce [to-path refs value]]
		out
	]
]
